...
*******************************************************/
function deleteDataTableRow(tableIdName, classNameId , el){
	swal({
		title : 'Are you sure?',
		...
		var curr_item = $(el).closest("tr").find("."+classNameId).val();
		table
        .row( $(el).parents('tr') )
        .remove()
        .draw();
		if(curr_item != ''){
			$("#deleteDataList tr").append( 
					'<td align="center">' + 
						'<input type="hidden" name="deleted_data[]" class="deleted-data" value="' + curr_item + '" />' +
					'</td>' 
			);
		}
	});
...
/***************** Start - Test Function for Passing values between Jsp Pages ******************/
...
/***************** End - Test Function for Passing values between Jsp Pages ******************/

/*
***********************************************************************************************
						Start of T-Code Button JQuery Functions
***********************************************************************************************
*/
	$("#btnTcode").on("click", function() {
	    $("#tCodeModal").modal();
	
	});
	$("#btnCancel, #btnTcodeModalClose").on("click", function() {
	    $("#tCodeModal").modal("hide");
	});

/*
-----------------------------------------------------------------------------------------------
					End of  T-Code Button JQuery Functions
-----------------------------------------------------------------------------------------------
*/
